...
10. Show data tables to the model as TOON/CSV when flat and uniform (`~/.claude/skills/token-saver/scripts/toon.py`), otherwise JSON.

<!-- user prefs -->
- Answer in plain, simple English — skip jargon or explain it in one phrase.
